...
export const checkAuthorizationTokenExistsMiddleware = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const checkIsAdminMiddleware = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const checkAuthorizationTokenMatchesUserIdMiddleware = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
